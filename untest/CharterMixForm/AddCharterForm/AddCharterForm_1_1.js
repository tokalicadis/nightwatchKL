//DODAJ CHARTER FORM - POTVRĐENO - AKONTACIJA OK
...
module.exports = {
    'Demo test kl-test' : function(browser) {
        browser
            ...
            //STATUS PLAĆANJA
            .waitForElementVisible('#booking\\[paymentStatus\\]')
            .setValue('#booking\\[paymentStatus\\]', 'Akontacija OK')

            //ROK ZA PLAĆANJE PUNOG IZNOSA
            .waitForElementVisible('#booking\\[paymentDeadlineDate\\]')
            .setValue('#booking\\[paymentDeadlineDate\\]', '11182021')
